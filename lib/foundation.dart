/// A collection of foundational classes and utilities used to build this SDK.
///
/// Most users will not need to use this library directly, but it is exposed for
/// advanced use-cases and for building custom tools or unexpected integrations.
library;
